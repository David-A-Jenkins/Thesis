...
source("DM_sim_logistic_1obperday_final_parallelised.R") # DM.sim.logistic.1
...
DM.sim.logistic.1(it, sampsize=365, valsize = 365,b_change1,b_change2,s1,s2,er,b_start,forget,job_id)
